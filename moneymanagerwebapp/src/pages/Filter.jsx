...
const Filter  = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            toast.error(error.message || "Failed to fetchh transactions. Please try again");
        }finally{
            setLoading(false);
        }
    }
                        ...
                        <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                            ...
                            <div className="sm:col-span-1 md:col-span-1 flex items-end ">
                                <div className="w-full ">
                                    ...
                                    <input value={keyword} type="text" placeholder="Search..." className="w-full border rounded px-3 py-2"  onChange={e=>setKeyword(e.target.value)}/>
                                </div>
