            ...
            <Dashboard activeMenu = "Category">
                <div className="my-5 mx-auto">
                    ...
                    <div className="flex justify-between items-center mb-5">
                        ...
                        <button onClick={() => setOpenAddCategoryModal(true )} className="flex items-center gap-1 bg-green-200 text-green-1000 px-4 py-2 rounded-lg hover:bg-green-600 transition-colors">
                            <Plus size={15}/>
                            Add Category
                        </button>
                    </div>
