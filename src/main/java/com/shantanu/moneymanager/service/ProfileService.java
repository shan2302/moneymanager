...
//                .password(profileEntity.getPassword())  we will not use here because we are not giving password directly to the client
    ...
    public Map<String, Object> authenaticeAndGenerateToken(AuthDTO authDTO) {
        try{
            System.out.println("Inside authenaticeAndGenerateToken:- ");
